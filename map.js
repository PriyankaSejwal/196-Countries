...
// Not using it in any functionality
function takeshot() {
...
function elevationchart() {
  ...
  // Chart constructor for the report page
  ...
  // Draw the report chart using the data within its DIV.
  reportchart.draw(joinedData2, reportoptions);
